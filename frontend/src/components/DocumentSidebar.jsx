...
export default function DocumentSidebar({ document, onHeadingClick, onSectionRewrite, protectedSections, onToggleProtection, structureLocked, onToggleStructureLock, pendingProposal = false }) {
